...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """if (print_incorrect_dogs):
        nbr_incorrect_dog = results_stats_dic['n_dogs_img'] - results_stats_dic["n_correct_notdogs"] - results_stats_dic["n_correct_dogs"]
        print(f'incorrectly classified dog images{nbr_incorrect_dog}')
    if (print_incorrect_breed):
        nbr_incorrect_breed = results_stats_dic['n_dogs_img'] - results_stats_dic['n_correct_breed']"""
